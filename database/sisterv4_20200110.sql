...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2020 at 05:12 AM
...
-- Database: `sisterv4`
--
CREATE DATABASE IF NOT EXISTS `sisterv4` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sisterv4`;
...
CREATE TABLE IF NOT EXISTS `akad_kegiatanakademik` (
...
CREATE TABLE IF NOT EXISTS `akad_siswaabsenharian` (
...
CREATE TABLE IF NOT EXISTS `apiemail` (
...
CREATE TABLE IF NOT EXISTS `m_biaya_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `m_gelombang_jalur` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `m_jalur` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `m_jalur_biaya` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `m_jenisptk` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `m_logoslip` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `m_statuskeaktifan` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) NOT NULL,
  `keterangan` text NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `m_statusnikah` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `m_statuspegawai` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `m_tahunakademik` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) NOT NULL,
  `tahun` varchar(50) NOT NULL,
...
(1, 'site_title', 'Sister ver CI'),
(2, 'site_description', 'Sister ver CI'),
...
CREATE TABLE IF NOT EXISTS `ppdb_formulir` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ppdb_formulir_jual` (
...
CREATE TABLE IF NOT EXISTS `ppdb_siswa` (
  ...
  `panggilansiswa` varchar(50) DEFAULT NULL,
  `agamasiswa` varchar(50) DEFAULT NULL,
  `kelaminsiswa` varchar(50) DEFAULT NULL,
  `tempatlahirsiswa` varchar(50) DEFAULT NULL,
  `tanggallahirsiswa` date DEFAULT NULL,
  `warganegarasiswa` varchar(50) DEFAULT NULL,
  ...
  `teleponsiswa` varchar(50) DEFAULT NULL,
  ...
  `jumlahsaudara` varchar(50) DEFAULT NULL,
  `bahasasiswa` varchar(50) DEFAULT NULL,
  ...
  `hpayah` varchar(50) DEFAULT NULL,
  ...
  `hpwali` varchar(50) DEFAULT NULL,
  `pendidikanwali` varchar(50) DEFAULT NULL,
  ...
  `gajiayah` varchar(50) DEFAULT NULL,
  `nikibu` varchar(50) DEFAULT NULL,
  `gajiibu` varchar(50) DEFAULT NULL,
  `gajiwali` varchar(50) DEFAULT NULL,
  `jenistinggal` varchar(50) DEFAULT NULL,
  `kelurahan` varchar(50) DEFAULT NULL,
  `kecamatan` varchar(50) DEFAULT NULL,
  `nopesertaun` varchar(50) DEFAULT NULL,
...
INSERT INTO `ppdb_siswa` (`id`, `tanggaldaftar`, `tahun_ppdb`, `sekolah_id`, `gelombang_id`, `jalur_id`, `jalurbiaya_id`, `noformulir`, `namasiswa`, `nis`, `nrp`, `nisn`, `nik`, `panggilansiswa`, `agamasiswa`, `kelaminsiswa`, `tempatlahirsiswa`, `tanggallahirsiswa`, `warganegarasiswa`, `beratsiswa`, `tinggisiswa`, `photosiswa`, `alamatsiswa`, `propinsisiswa`, `kotasiswa`, `kodepossiswa`, `teleponsiswa`, `hpsiswa`, `emailsiswa`, `sekolahasal`, `alamatsekolahasal`, `ijazah`, `skhun`, `statusanak`, `anakke`, `jumlahsaudara`, `bahasasiswa`, `statusayah`, `namaayah`, `tempatlahirayah`, `tanggallahirayah`, `agamaayah`, `alamatayah`, `propinsiayah`, `kotaayah`, `teleponayah`, `hpayah`, `pendidikanayah`, `pekerjaanayah`, `statusibu`, `namaibu`, `tempatlahiribu`, `tanggalahiribu`, `agamaibu`, `alamatibu`, `propinsiibu`, `kotaibu`, `teleponibu`, `hpibu`, `pendidikanibu`, `pekerjaanibu`, `statuswali`, `namawali`, `tempatlahirwali`, `tanggallahirwali`, `agamawali`, `alamatwali`, `propinsiwali`, `kotawali`, `teleponwali`, `hpwali`, `pendidikanwali`, `pekerjaanwali`, `ppdb_status`, `noakta`, `jarak`, `transportasi`, `nikayah`, `gajiayah`, `nikibu`, `gajiibu`, `gajiwali`, `jenistinggal`, `kelurahan`, `kecamatan`, `nopesertaun`, `image`, `emailortu`) VALUES
(1, '2016-12-08 03:00:00', '2019', '1', '1', '2', '7', '0001', 'FAHMI MUHLISIN', '190001', '', '', 'test123', '', 'Islam', 'Laki-Laki', 'Medan', '2005-06-18', 'INDONESIA', '1', '1', '', 'test123', 'test123', 'test123', '', '', '0', 'rekysda@gmail.com', 'SMPN 1 GALIS PAMEKASAN', '', '', '', 'Kandung', '1', '1', 'INDONESIA', 'Hidup', 'JAFAR', '', '0000-00-00', 'Islam', 'test123', 'test123', 'test123', '', '081335054383', 'SMU/SMK', 'test123', 'Hidup', 'ISABEL', '', '0000-00-00', 'Islam', 'test123', 'test123', 'test123', '', 'test123', 'SMU/SMK', 'test123', 'Hidup', '', '', '0000-00-00', 'Islam', '', '', '', '', '', 'SMU/SMK', '', 'aktif', '', '', '', 'test123', '0', '123', '', '', '', 'test123', 'test123', '', 'default.jpg', 'rekysda@gmail.com'),
(3, '2016-07-03 03:00:00', '2020', '', '1', '2', NULL, '0003', 'FIRHAN GHULAM ACHMAD', '190002', '', '', '', '', 'Islam', 'Laki-Laki', '', '2019-08-28', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMP', '', '', '', 'kandung', '0003', '0003', 'INDONESIA', 'Hidup', 'BRIAN', '', '0000-00-00', 'Islam', '0003', '0003', '0003', '', '081335054383', 'SMU/SMK', '0003', 'Hidup', 'RAHAYU', '0003', '0000-00-00', 'Islam', '0003', '0003', '0003', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', '0003', '0', '0003', '', '0', '', '0003', '0003', '', 'default.jpg', ''),
(5, '2016-07-03 03:00:00', '2019', '0', '1', '3', '', '0005', 'GEOVANY EDY W', '190003', '', '', '', '', 'Islam', 'Laki-Laki', '', '2010-06-21', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMP HANG TUAH 4 SURABAYA', '', '', '', 'kandung', '2', '2', 'INDONESIA', 'Hidup', 'ALEX', '', '0000-00-00', 'Islam', 'GEOVANY ', 'GEOVANY ', 'GEOVANY ', '', '081335054383', 'SMU/SMK', 'GEOVANY ', 'Hidup', 'GEOVANY ', '', '0000-00-00', 'Islam', 'GEOVANY ', 'GEOVANY ', 'GEOVANY ', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', 'GEOVANY ', '0', 'GEOVANY ', '', '0', '', 'GEOVANY ', 'GEOVANY ', '', 'default.jpg', ''),
(11, '2016-07-03 03:00:00', '2019', '0', '1', '3', '', '0011', 'Ivana Kristiono', '190009', '', '', '', '', 'Islam', 'Perempuan', '', '0000-00-00', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMP', '', '', '', '1', '', '', 'INDONESIA', '1', 'DIDIT MULYANTO', '', '0000-00-00', '3', '', '', '', '', '081249991001', '', '', '1', 'KARMELIA', '', '0000-00-00', '3', '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', '', '0', '', '', '0', '', '', '', '', 'default.jpg', ''),
(12, '2016-07-03 03:00:00', '2019', '0', '1', '3', '', '0012', 'Janet Ellora Wibowo', '190010', '', '', '', '', 'Islam', 'Perempuan', '', '0000-00-00', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMPN 1 PURWOHARJO', '', '', '', '1', '', '', 'INDONESIA', '1', 'TOTO ISKANDAR', '', '0000-00-00', '3', '', '', '', '', '081249991001', '', '', '1', 'RAISO', '', '0000-00-00', '3', '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', '', '0', '', '', '0', '', '', '', '', 'default.jpg', ''),
(13, '2019-08-28 06:36:51', '2020', '0', '1', NULL, NULL, '2010', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'calon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'default.jpg', '');
...
CREATE TABLE IF NOT EXISTS `ppdb_status` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `ppdb_status_anak` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `ppdb_status_ortu` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `sar_inventaris` (
...
CREATE TABLE IF NOT EXISTS `siswa_bayar_batal` (
...
CREATE TABLE IF NOT EXISTS `siswa_bayar_detail` (
...
CREATE TABLE IF NOT EXISTS `siswa_bayar_master` (
...
CREATE TABLE IF NOT EXISTS `siswa_keterangan` (
...
CREATE TABLE IF NOT EXISTS `siswa_keuangan` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
(53, 1, 2, 15000000, 0, 'ppdb', 3, '2020-01-10 11:03:32', '0000-00-00 00:00:00'),
(54, 1, 4, 1000000, 0, 'ppdb', 3, '2020-01-10 11:03:32', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `siswa_pemutihan_batal` (
  `id_master` int(11) NOT NULL,
  `nomor_nota` varchar(40) NOT NULL,
  `tanggal` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `keterangan_batal` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `siswa_pemutihan_detail` (
  `id_detail` int(1) unsigned NOT NULL AUTO_INCREMENT,
  `id_master` int(1) unsigned NOT NULL,
  `biaya_id` int(1) NOT NULL,
  `jenis` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `siswa_pemutihan_master` (
  `id_master` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `nomor_nota` varchar(40) NOT NULL,
  `tanggal` datetime NOT NULL,
  `totalcart` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `siswa_spp` (
  `siswa_id` int(6) NOT NULL,
  `nominal` varchar(50) NOT NULL,
  PRIMARY KEY (`siswa_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
