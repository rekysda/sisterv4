...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2020 at 07:06 AM
...
CREATE TABLE IF NOT EXISTS `akad_journalkbm` (
`id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bk_kategori_pelanggaran` (
`id` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bk_pelanggaran` (
`id` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bk_siswapelanggaran` (
`id` int(5) NOT NULL,
  `tahunakademik_id` varchar(10) NOT NULL,
  `semester` varchar(10) NOT NULL,
  `tanggal` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bk_siswaprestasi` (
`id` int(5) NOT NULL,
  `tahunakademik_id` varchar(10) NOT NULL,
  `semester` varchar(10) NOT NULL,
  `tanggal` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bk_tingkat` (
`id` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `m_apilist` (
`id` int(5) NOT NULL,
  `nama` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ppdb_berkas` (
`id` int(5) NOT NULL,
...
(3, '2016-07-03 03:00:00', '1', '2019', '1', '2', '6', '190003', 'FIRHAN GHULAM ACHMAD', '190002', '', '', '', '', 'Islam', 'Laki-Laki', '', '2019-08-28', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMP', '', '', '', 'kandung', '0003', '0003', 'INDONESIA', 'Hidup', 'BRIAN', '', '0000-00-00', 'Islam', '0003', '0003', '0003', '', '081335054383', 'SMU/SMK', '0003', 'Hidup', 'RAHAYU', '0003', '0000-00-00', 'Islam', '0003', '0003', '0003', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'calon', '', '', '', '0003', '0', '0003', '', '0', '', '0003', '0003', '', 'default.jpg', '', '', ''),
(5, '2016-07-03 03:00:00', '1', '2019', '1', '3', '', '190005', 'GEOVANY EDY W', '190003', '', '', '', '', 'Islam', 'Laki-Laki', '', '2010-06-21', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMP HANG TUAH 4 SURABAYA', '', '', '', 'kandung', '2', '2', 'INDONESIA', 'Hidup', 'ALEX', '', '0000-00-00', 'Islam', 'GEOVANY ', 'GEOVANY ', 'GEOVANY ', '', '081335054383', 'SMU/SMK', 'GEOVANY ', 'Hidup', 'GEOVANY ', '', '0000-00-00', 'Islam', 'GEOVANY ', 'GEOVANY ', 'GEOVANY ', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', 'GEOVANY ', '0', 'GEOVANY ', '', '0', '', 'GEOVANY ', 'GEOVANY ', '', 'default.jpg', '', '2019-06-06', 'X IPA 1'),
(6, '2016-07-03 03:00:00', '1', '2019', '1', '3', '', '190006', 'Cynthia Budiyanto', '190004', '', '', '', '', 'Islam', 'Perempuan', '', '0000-00-00', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMPN 3 MUNCAR', '', '', '', '1', '', '', 'INDONESIA', '1', 'BENYAMIN', '', '0000-00-00', '3', '', '', '', '', '081249991001', '', '', '1', 'ELOK', '', '0000-00-00', '3', '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', '', '0', '', '', '0', '', '', '', '', 'default.jpg', '', '', ''),
(7, '2016-07-03 03:00:00', '1', '2019', '1', '3', '', '190007', 'Clara Graciella Alim', '190005', '', '', '', '', 'Islam', 'Perempuan', '', '0000-00-00', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'SMPN 1 JOMBANG', '', '', '', '1', '', '', 'INDONESIA', '1', 'BURHAN', '', '0000-00-00', '3', '', '', '', '', '081249991001', '', '', '1', 'LISA', '', '0000-00-00', '3', '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', '', '0', '', '', '0', '', '', '', '', 'default.jpg', '', '', ''),
(8, '2016-07-03 03:00:00', '1', '2019', '1', '3', '', '190008', 'Agatha Tirtana', '190006', '', '', '', '', 'Islam', 'Perempuan', '', '0000-00-00', 'INDONESIA', '', '', '', '', '', '', '', '', '0', '', 'MTSN 1 MATARAM', '', '', '', '1', '', '', 'INDONESIA', '1', 'MIKAIL', '', '0000-00-00', '3', '', '', '', '', '081249991001', '', '', '1', 'JENNY', '', '0000-00-00', '3', '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', 'aktif', '', '', '', '', '0', '', '', '0', '', '', '', '', 'default.jpg', '', '', ''),
...
CREATE TABLE IF NOT EXISTS `ppdb_siswa_jalur` (
`id` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_catatan_walikelas` (
`id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_jadwal_pelajaran` (
`id` int(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_kelompok_mapel` (
`id` int(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_mapel` (
`id` int(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_nilai_extrakulikuler` (
`id` int(10) NOT NULL,
  `tahunakademik_id` varchar(10) NOT NULL,
  `siswa_id` varchar(10) NOT NULL,
  `kelas_id` varchar(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_nilai_keterampilan` (
`id` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_nilai_pengetahuan` (
`id` int(5) NOT NULL,
  `jadwal_id` varchar(50) NOT NULL,
  `tahunakademik_id` varchar(50) NOT NULL,
  `mapel_id` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_nilai_prestasi` (
`id` int(10) NOT NULL,
  `tahunakademik_id` int(5) NOT NULL,
  `siswa_id` varchar(20) NOT NULL,
  `kelas_id` varchar(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_nilai_sikap_semester` (
`id` int(10) NOT NULL,
  `tahunakademik_id` int(5) NOT NULL,
  `siswa_id` varchar(20) NOT NULL,
  `kelas_id` varchar(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `r_siswa_masuk` (
...
CREATE TABLE IF NOT EXISTS `siswa_deviceid` (
  `nis` int(20) NOT NULL,
